...
/*
    ...
    * Description: Template for displaying the films page with selected posts.
    */
get_header(); ?>
    ...
    <div class="list_page_content">
        ...
        <div class="list_container">
            ...
            <div class="load_more_btn">
                <button id="more_posts" data-type="film" class="load_more_text">LOAD MORE <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/images/right-symbol.png" /></a>
            </div>
        </div>
    </div>
